<template>
  <div class="contact-page">
    <h1>Contact Us</h1>
    <p>
      Thank you for reaching out to us! Your inquiries are important to us, and we appreciate your<br> interest in
      our products or services.<br>Our dedicated team is available to assist you on weekdays from 8:30 AM to 5:00
      PM and on<br> Saturday from 8:30 AM to 12:30 PM.
    </p>

    <div class="contact-info">
      <p><b>Phone: +94412283654</b></p>
      <p><b>Email: <a href="mailto:uruwalatea@gmail.com">uruwalatea@gmail.com</a></b></p>
    </div>
    ...
    <div class="contact-form">
      <form @submit.prevent="submitForm">
        ...
        <div class="form-group">
          <label for="customerId"><b>Customer ID <i class="fas fa-user"></i>:</b></label>
        ...
        <div class="form-group">
          <label for="name"><b>Customer Name <i class="fas fa-user"></i>:</b></label>
          <input type="text" id="name" v-model="fBackCusName" required>
        </div>
        <div class="form-group">
          <label for="email"><b>Email <i class="fas fa-envelope"></i>:</b></label>
        ...
        <div class="button-group">
          <button type="submit" @click="submitForm">Submit<i class="fas fa-check"></i></button>
